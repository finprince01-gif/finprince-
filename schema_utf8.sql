...
--
-- Host: localhost    Database: Finpixe_AI_Accounting
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Customer Master Category Hierarchy';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `customer_master_longtermcontracts_productservices` (
  ...
  `acceptable_price_deviation` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'e.g., Γö¼ΓûÆ5%',
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `created_by` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_by` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `inventory_master_inventoryitems` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tenant_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item_code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Item Code',
  `item_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Item Name',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT 'Item Description',
  `category_id` bigint DEFAULT NULL COMMENT 'Foreign key to inventory_master_category',
  `category_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Full category path string',
  ...
  `vendor_specific_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vendor_specific_suffix` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `uom` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Unit of Measure',
  `alternate_uom` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Alternate Unit',
  ...
  `rate_unit` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Rate per Unit',
  `hsn_code` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gst_rate` decimal(5,2) DEFAULT NULL,
  `cess_rate` decimal(5,2) DEFAULT NULL,
  `reorder_level` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Reorder Level Information',
  `reorder_level_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Second Reorder Level Information',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Inventory Master Items';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `master_chart_of_accounts` (
  ...
  `import_version` varchar(20) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Sales Voucher Master';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Vendor Master Banking Information';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Vendor Master Basic Details for vendor creation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Vendor Master GST Details';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Vendor Master Products/Services (JSON array per vendor)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Vendor Master TDS & Other Statutory Details';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Vendor Master Terms and Conditions';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `voucher_sales_invoicedetails` (
  ...
  `place_of_supply` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'State code (01-38)',
  `reverse_charge` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT 'N' COMMENT 'Y or N',
  `invoice_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'Regular' COMMENT 'Regular, SEZ with payment, etc.',
  `gst_export_type` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'WPAY or WOPAY for exports',
  `port_code` varchar(6) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '6-digit port code for exports',
  `shipping_bill_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Shipping bill number for exports',
  `shipping_bill_date` date DEFAULT NULL COMMENT 'Shipping bill date for exports',
  `ecommerce_gstin` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'E-commerce GSTIN',
  `irn` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ack_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2026-03-24 18:01:29


-- ------------------------------------------------------
-- MANUAL UPDATES (Applied via ALTER queries)
-- ------------------------------------------------------
ALTER TABLE `invoice_ocr_temp` MODIFY `expires_at` datetime NULL;


-- ---------------------------------------------------------------------------
-- IDENTITY HARDENING UPDATES (2026-03-25)
-- ---------------------------------------------------------------------------
ALTER TABLE `invoice_ocr_temp` 
  ADD COLUMN IF NOT EXISTS `group_id` varchar(64) DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS `financial_year` varchar(20) DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS `selected_by` varchar(50) DEFAULT 'FALLBACK',
  ADD COLUMN IF NOT EXISTS `duplicate_count` int DEFAULT '0',
  ADD COLUMN IF NOT EXISTS `version_rank` int DEFAULT '99',
  ADD COLUMN IF NOT EXISTS `is_primary` tinyint(1) DEFAULT '0';

CREATE INDEX IF NOT EXISTS `idx_ocr_temp_group` ON `invoice_ocr_temp` (`group_id`);

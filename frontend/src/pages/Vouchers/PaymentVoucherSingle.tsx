...
const PaymentVoucherSingle: React.FC<PaymentVoucherSingleProps> = ({
        ...
        if (prefilledData) {
            ...
            if (isReadOnlyMode && (prefilledData as any).items && Array.isArray((prefilledData as any).items)) {
                ...
                if (advanceItem) {
                    ...
                    const isAutoGenerated = itemRefNo && vNum && itemRefNo === vNum;
    ...
    useEffect(() => {
        if (selectedPaymentConfig && paymentVoucherConfigs.length > 0) {
            ...
            if (config) {
                if (prefilledData && ((prefilledData as any).paymentVoucherNumber || (prefilledData as any).invoiceNumber)) {
                    setVoucherNumber((prefilledData as any).paymentVoucherNumber || (prefilledData as any).invoiceNumber);

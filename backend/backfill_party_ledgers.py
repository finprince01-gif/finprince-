...
def run_backfill():
    queries = [
        ...
        JOIN master_ledgers l 
          ON c.tenant_id = l.tenant_id COLLATE utf8mb4_unicode_ci 
         AND c.customer_name = l.name COLLATE utf8mb4_unicode_ci
        ...
        JOIN master_ledgers l 
          ON v.tenant_id = l.tenant_id COLLATE utf8mb4_unicode_ci 
         AND v.vendor_name = l.name COLLATE utf8mb4_unicode_ci
        ...
        """
        UPDATE vouchers v
        LEFT JOIN customer_master_customer_basicdetails c 
          ON v.tenant_id = c.tenant_id COLLATE utf8mb4_unicode_ci 
         AND v.party = c.customer_name COLLATE utf8mb4_unicode_ci
        LEFT JOIN vendor_master_vendorcreation_basicdetail ven 
          ON v.tenant_id = ven.tenant_id COLLATE utf8mb4_unicode_ci 
         AND v.party = ven.vendor_name COLLATE utf8mb4_unicode_ci
        SET 

...
class CustomerMasterCustomerTDS(models.Model):
    ...
    # TCS Details
    tcs_section = models.CharField(max_length=500, null=True, blank=True, help_text='TCS Section')
    tcs_enabled = models.BooleanField(default=False, help_text='Is TCS Enabled')
    
    # TDS Details
    tds_section = models.CharField(max_length=500, null=True, blank=True, help_text='TDS Section')

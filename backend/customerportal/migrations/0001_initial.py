    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tcs_section', models.CharField(blank=True, help_text='TCS Section', max_length=500, null=True)),
                ('tcs_enabled', models.BooleanField(default=False, help_text='Is TCS Enabled')),
                ('tds_section', models.CharField(blank=True, help_text='TDS Section', max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('invoice', 'Invoice'), ('payment', 'Payment'), ('receipt', 'Receipt'), ('credit_note', 'Credit Note'), ('debit_note', 'Debit Note')], max_length=20)),

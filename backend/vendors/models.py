...
class VendorMasterTDS(models.Model):
    ...
    # TDS Information
    tds_section_applicable = models.CharField(max_length=255, blank=True, null=True, help_text="TDS Section Applicable")
    ...
    tcs_section = models.CharField(max_length=500, blank=True, null=True, help_text="TCS Section (alternate)")

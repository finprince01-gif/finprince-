...
snap = {
    ...
    'db': {
        ...
        'extracting_records': [str(rec['id']) for rec in extracting],
        'not_finalized': len(not_fin),
        'page_results': pr_count,
        'poison_documents': str(pd_count),
    }
}

...
session_id = "f7038ea8-2ccd-48c9-bb2f-97619585125d"
...
for p in ppqs:
    print(f"ID={p.id}, invoice_no={p.invoice_number}, record_id={p.source_scan_row_id}, status={p.pending_purchase_status}")

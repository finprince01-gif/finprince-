...
#     """
#     PermissionLog Model - Audit trail for permission changes
#     
#     Tracks who changed what permissions and when for compliance and debugging.
#     """
#     role = models.ForeignKey(
#         Role,
#         on_delete=models.CASCADE,
#         related_name='permission_logs',
#         help_text="Role that was modified"
#     )
...
#     )
#     old_permissions = models.JSONField(null=True, blank=True, help_text="Previous permissions")
#     new_permissions = models.JSONField(null=True, blank=True, help_text="New permissions")
...
#     
#     def __str__(self):
#         return f"{self.action} - {self.role.name} by {self.changed_by} at {self.created_at}"

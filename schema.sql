...
`id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `vendor_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `branch` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `supplier_invoice_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gstin` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
`id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'UPLOADED',
...
`id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `reference_type` varchar(50) NOT NULL DEFAULT 'invoice',
